            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start max-w-6xl mx-auto">
              ...
              >
                ...
                <ul className="space-y-4 mb-10 min-h-[220px]">
                  {["8 Active AI Matters", "20 Documents per Case", "15MB max File Size", "2GB Total Storage", "Unlimited Standard Intelligence Engine", "SOC2-ready infrastructure"].map((f, i) => (
              ...
              >
                ...
                <ul className="space-y-4 mb-10 min-h-[220px]">
                  {["18 Active AI Matters", "50 Documents per Case", "50MB max File Size", "15GB Total Storage", "Unlimited Deep Intelligence Engine", "HIPAA-ready security architecture"].map((f, i) => (
              ...
              >
                ...
                <ul className="space-y-4 mb-10 min-h-[220px]">
                  {["∞ Unlimited Active Matters", "∞ Unlimited Documents", "100MB max File Size", "100GB Total Storage", "Elite Intelligence Engine Included", "Dedicated Success Manager"].map((f, i) => (
                    <li key={i} className="flex items-center gap-3 text-slate-400 text-sm">
                      <Check size={18} className="text-primary" /> {f}
                    </li>
                  ))}
