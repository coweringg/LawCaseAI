...
export default function PricingClient() {
  ...
  const businessPrice = seats * (billingInterval === 'annual' ? 240 : 300);
  ...
  return (
    <PublicLayout>
      <section className="relative pt-32 pb-24 overflow-hidden">
        <div className="container-stitch px-4 relative z-10 text-center">
          <motion.div
            initial="initial"
            animate="animate"
            variants={fadeInUp}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start max-w-6xl mx-auto">
              ...
              >
                ...
                <ul className="space-y-4 mb-10 min-h-[220px]">
                  {["8 Active AI Matters", "20 Documents per Case", "15MB max File Size", "2GB Total Storage", "Cross-Thread Intelligence", "Unlimited Standard Intelligence Engine", "SOC2-ready infrastructure"].map((f, i) => (
              ...
              >
                ...
                <ul className="space-y-4 mb-10 min-h-[220px]">
                  {["18 Active AI Matters", "50 Documents per Case", "50MB max File Size", "15GB Total Storage", "Cross-Thread Intelligence", "Unlimited Deep Intelligence Engine", "HIPAA-ready security architecture"].map((f, i) => (
              ...
              >
                <div className="mb-8">
                  ...
                  <div className="flex items-baseline gap-2 mb-2">
                    ...
                    <span className="text-6xl font-black text-white tracking-tighter">${billingInterval === 'annual' ? '240' : getProratedPrice(300)}</span>
                    <div className="flex flex-col">
                      <span className="text-slate-500 font-black text-xs uppercase tracking-widest">/mo</span>
                    </div>
                  </div>
                  {billingInterval === 'annual' && (
                    <div className="text-[10px] text-slate-500 font-bold mb-2">
                      Billed annually (${getProratedPrice(240 * 12)})
                    </div>
                  )}
                  {user?.plan && user.plan !== 'none' && currentPlanCost < (billingInterval === 'annual' ? 240 * 12 : 300) && (
                ...
                <ul className="space-y-4 mb-10 min-h-[220px]">
                  {["∞ Unlimited Active Matters", "∞ Unlimited Documents", "100MB max File Size", "100GB Total Storage", "Cross-Thread Intelligence", "Elite Intelligence Engine Included", "Dedicated Success Manager"].map((f, i) => (
                    <li key={i} className="flex items-center gap-3 text-slate-400 text-sm">
                      <Check size={18} className="text-primary" /> {f}
                    </li>
                  ))}
      ...
      <section className="py-24 relative overflow-hidden bg-white/5 border-y border-white/10">
        ...
        <div className="container-stitch max-w-5xl px-4 text-center relative z-10">
          <motion.div
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-black text-white uppercase tracking-tighter mb-6 relative z-10 leading-[1.3] pb-2 text-balance">
            ...
            <p className="text-xl md:text-2xl text-slate-300 font-medium mb-10 max-w-3xl mx-auto relative z-10 leading-relaxed text-balance">
      ...
      <section className="py-32 relative border-b border-white/5">
        <div className="container-stitch px-4 max-w-4xl">
