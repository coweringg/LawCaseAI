...
import { AlertTriangle, ChevronRight, Cpu, FileText, Scale, Shield } from 'lucide-react';
      ...
      <main className="relative z-10 pt-32 pb-24 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <h1 className="text-5xl xl:text-6xl font-black text-white mb-6 font-display tracking-tightest leading-tight text-balance">
          ...
          <div className="mt-16 text-center">
            <Link href="/refund" className="inline-flex items-center gap-2 text-xs font-black uppercase tracking-widest text-slate-500 hover:text-white transition-colors">
              <Shield size={14} />
