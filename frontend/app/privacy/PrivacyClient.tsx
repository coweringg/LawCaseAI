            ...
            <div className="p-12 space-y-12">
              <section className="space-y-6">
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex gap-4 p-4 rounded-2xl bg-white/[0.02] border border-white/5">
                    ...
                    <div className="flex-1">
                      <p className="text-white font-bold text-sm">System Usage Data</p>
                      <p className="text-slate-500 text-xs">Structural data required for indexation and search optimization.</p>
                    </div>
                  </li>
                </ul>
              </section>
              ...
              <section className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <h2 className="text-2xl font-black text-white uppercase tracking-tighter">AI Processing Security</h2>
                </div>
                <p className="text-slate-400 leading-relaxed font-medium">
              ...
              <section className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <h2 className="text-2xl font-black text-white uppercase tracking-tighter">Data Retention & Cookies</h2>
                </div>
                <p className="text-slate-400 leading-relaxed font-medium">
              ...
              <section className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {['Data Export', 'Account Purge', 'Processing Restriction', 'Access Logs Review'].map((right, i) => (
