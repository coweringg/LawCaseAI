...
// USER ROUTES
app.get('/api/user/profile', authenticate, (req: AuthRequest, res: Response) => {
  const user = req.user
...
app.put('/api/user/profile', authenticate, (req: AuthRequest, res: Response) => {
  const user = req.user
...
// CASE ROUTES
app.get('/api/cases', authenticate, (req: AuthRequest, res: Response) => {
  const user = req.user
...
app.post('/api/cases', authenticate, (req: AuthRequest, res: Response) => {
  const user = req.user
...
app.get('/api/cases/:id', authenticate, (req: AuthRequest, res: Response) => {
  const user = req.user
  const { id } = req.params
...
app.put('/api/cases/:id', authenticate, (req: AuthRequest, res: Response) => {
  const user = req.user
  const { id } = req.params
...
app.delete('/api/cases/:id', authenticate, (req: AuthRequest, res: Response) => {
  const user = req.user
  const { id } = req.params
...
// FILE ROUTES
app.post('/api/files/upload', authenticate, (req: AuthRequest, res: Response) => {
  const user = req.user
...
app.get('/api/files/case/:caseId', authenticate, (req: AuthRequest, res: Response) => {
  const user = req.user
...
app.delete('/api/files/:id', authenticate, (req: AuthRequest, res: Response) => {
  const user = req.user
  const { id } = req.params
...
// CHAT ROUTES
app.get('/api/chat/case/:caseId', authenticate, (req: AuthRequest, res: Response) => {
  const user = req.user
  const { caseId } = req.params
...
app.post('/api/chat/case/:caseId', authenticate, (req: AuthRequest, res: Response) => {
  const user = req.user
  const { caseId } = req.params
...
app.get('/api/admin/users', authenticate, (req: AuthRequest, res: Response) => {
  const user = req.user
...
app.put('/api/admin/users/:id/status', authenticate, (req: AuthRequest, res: Response) => {
  const user = req.user
...
app.put('/api/admin/users/:id/plan', authenticate, (req: AuthRequest, res: Response) => {
  const user = req.user

  if (user.role !== 'admin') {
    return res.status(403).json({
      success: false,
      message: 'Access denied. Admin role role required.'
    })
  }
  ...
  targetUser.planLimit = planLimits[plan as keyof typeof planLimits]
