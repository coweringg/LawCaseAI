    ...
    return (
        <PublicLayout>
            ...
            <section className="sticky top-16 z-40 bg-background-dark/40 backdrop-blur-2xl border-b border-white/10 py-6">
                <div className="container-stitch px-4 flex items-center justify-center gap-4 md:gap-10 overflow-x-auto no-scrollbar scroll-smooth">
                    {[
            ...
            <section className="py-32 relative overflow-hidden border-t border-white/5">
                <div className="container-stitch px-4 text-center relative z-10">
                    <motion.div
                    ...
                    <h2 className="text-4xl md:text-6xl font-black text-white mb-12 font-display tracking-tight text-balance">Bank-Grade <span className="text-primary">Security</span></h2>
